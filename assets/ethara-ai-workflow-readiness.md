...
- `flat50-ad-1080x1080.png`: final square social media creative.
- `flat50-ad.ai`: Illustrator source file.
- `flat50-ad-editable.svg`: editable vector version.
- `photoshop-assessment.psd`: Photoshop assessment source.
- `photoshop-editable-source.psd`: additional editable Photoshop source.

## Visual QA Checklist

- Offer hierarchy is clear at first glance.
- Primary text has strong contrast and readable spacing.
